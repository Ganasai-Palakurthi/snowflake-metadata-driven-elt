...
COPY INTO SALES_ORDER_DETAIL_RAW
    FROM @SALES_DWH_DEV.CONTROL.BRONZE_STAGE/sales_order_detail/
    FILE_FORMAT = (FORMAT_NAME = SALES_DWH_DEV.CONTROL.CSV_FILE_FORMA);
...
COPY INTO SALES_ORDER_HEADER_RAW
    FROM @SALES_DWH_DEV.CONTROL.BRONZE_STAGE/sales_order_header/
    FILE_FORMAT = (FORMAT_NAME = SALES_DWH_DEV.CONTROL.CSV_FILE_FORMA);
